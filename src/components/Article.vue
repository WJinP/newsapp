<template>
    <div id="article">
		...
		<div class="content">
			<div class="header clear"><h2><img :src="articleData.author_face" alt="" width="150"/></h2><p>吴金平</p></div>
		    <div class="cont">
		    	<h3>{{articleData.title}}</h3>
		        <div class="time"><p>{{articleData.time | normalTime}}<span><img src="../assets/img/zan.png" alt=""/></span></p></div>
		        <div id="p1" class="text-box" v-html="articleData.content">
...
export default {
	...
	mounted() {
		var reg=/\/article\/(\d+)/;
		//alert(this.$route.path.match(reg)[1]);
...
<style scoped>
	...
	#p1{ line-height:0.45rem; margin-bottom:0.1rem;text-indent: 2em;margin: 10px;}
